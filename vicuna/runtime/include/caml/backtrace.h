...
#ifndef OCAML_C_CHECKER_BACKTRACE_H
#define OCAML_C_CHECKER_BACKTRACE_H
...
// FIXME: this treatment of the global variable is far from ideal; substitute for
// Caml_state_field needed
int caml_state_backtrace_pos = 0;
#define caml_backtrace_pos (caml_state_backtrace_pos)
 ...
 */
// FIXME: support caml_backtrace_last_exn
#define caml_backtrace_last_exn (*((value *)_ffi_fresh_active_value_ptr()))
...
#endif /* OCAML_C_CHECKER_BACKTRACE_H */
