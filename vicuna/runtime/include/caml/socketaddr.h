...
// Origin: otherlibs/unix/socketaddr.h

#ifndef OCAML_C_CHECKER_SOCKET_ADDR_H
#define OCAML_C_CHECKER_SOCKET_ADDR_H
...
#define GET_INET_ADDR(v) (*(val_get_in_addr(v)))

#ifdef HAS_IPV6
extern value caml_unix_alloc_inet6_addr (struct in6_addr * inaddr);
#define GET_INET6_ADDR(v) (*(val_get_in6_addr(v)))
...
#endif /* OCAML_C_CHECKER_SOCKET_ADDR_H */
